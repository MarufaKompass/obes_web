      ...
      <div className="container">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <div
              className="inline-block rounded-lg px-3 py-1 text-[18px] font-medium"
              style={{ fontFamily: "poppins" }}
            >
              Our Services
            </div>
            <h2
              className="text-[28px] font-bold md:text-[38px] leading-10 tracking-normal"
              style={{ fontFamily: "poppins" }}
            >
              Comprehensive Healthcare Solutions
            </h2>
            <p
              className="max-w-[900px] text-muted-foreground text-[14px] md:text-[18px]"
              style={{ fontFamily: "poppins" }}
            >
